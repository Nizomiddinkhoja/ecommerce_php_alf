...
class PagerService
{
    public static function printPager()
    {
        ...
        <div class="pager">
            <?php print '<div class="link-to-begin"><a href="?model=product&action=all'
                . (isset($_GET['category_id']) ? '&category_id=' . $_GET['category_id'] : '')
                . '&page=1"><<</a></div>' ?>
            <?php print '<div class="link-to-left"><a href="?model=product&action=all'
                . (isset($_GET['category_id']) ? '&category_id=' . $_GET['category_id'] : '')
            ...
            <?php print '<div class="link-to-right"><a href="?model=product&action=all'
                . (isset($_GET['category_id']) ? '&category_id=' . $_GET['category_id'] : '')
                . '&page=' . ($currentPage + 1) . '">></a></div>' ?>
